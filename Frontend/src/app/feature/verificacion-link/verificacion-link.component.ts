    ...
    <div class="max-w-6xl mx-auto space-y-6 animate-in fade-in duration-300">
      ...
      <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <button 
            (click)="loadLinks()" 
            class="px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold rounded-xl text-sm transition-all flex items-center gap-1.5">
            🔄 Actualizar
          </button>
        </div>
      </div>
                ...
                <div class="space-y-4">
                  <div class="grid grid-cols-2 gap-4 text-sm">
                    <div class="bg-gray-50 p-3 rounded-xl col-span-2">
                      ...
                      <span class="font-semibold text-gray-800 mt-1 block">{{ visaDetails()?.nombre }}</span>
                    </div>
                    ...
                    <div class="bg-gray-50 p-3 rounded-xl">
                      ...
                      <span class="font-bold mt-1 block" [class]="visaDetails()?.estado === 'PAID' ? 'text-emerald-600' : 'text-amber-600'">
                        {{ visaDetails()?.estado }}
                      </span>
                    </div>
                  </div>
